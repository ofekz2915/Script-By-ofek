...
RegisterServerEvent('mechanic:logs')

AddEventHandler('mechanic:logs', function(data, src)
	...
	PerformHttpRequest(url, function(err, text, headers) end, 'POST', json.encode({username = "mechanic-logs", content = "```css\n[" .. time .. "] " .. data .. "```"}), {['Content-Type'] = 'application/json'})
