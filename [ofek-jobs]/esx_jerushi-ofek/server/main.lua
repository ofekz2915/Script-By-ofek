...
TriggerEvent('esx_society:registerSociety', 'jerushi', 'jerushi', 'society_jerushi', 'society_jerushi', 'society_jerushi', {type = 'public'})



RegisterServerEvent('jerushi:logs')

AddEventHandler('jerushi:logs', function(data, src)
	...
	PerformHttpRequest(url, function(err, text, headers) end, 'POST', json.encode({username = "jerushi-logs", content = "```css\n[" .. time .. "] " .. data .. "```"}), {['Content-Type'] = 'application/json'})
