...
TriggerEvent('esx_society:registerSociety', 'asulin', 'asulin', 'society_asulin', 'society_asulin', 'society_asulin', {type = 'public'})



RegisterServerEvent('asulin:logs')

AddEventHandler('asulin:logs', function(data, src)
	...
	PerformHttpRequest(url, function(err, text, headers) end, 'POST', json.encode({username = "asulin-logs", content = "```css\n[" .. time .. "] " .. data .. "```"}), {['Content-Type'] = 'application/json'})
