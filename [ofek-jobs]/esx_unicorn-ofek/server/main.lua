...
RegisterServerEvent('unicorn:logs')

AddEventHandler('unicorn:logs', function(data, src)
	...
	PerformHttpRequest(url, function(err, text, headers) end, 'POST', json.encode({username = "unicorn-logs", content = "```css\n[" .. time .. "] " .. data .. "```"}), {['Content-Type'] = 'application/json'})
