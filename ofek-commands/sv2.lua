...
TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = ' יש לך ' .. wallet .. ' מזומן'})
...
TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = ' יש לך ' .. bank .. '  בחשבון הבנק'})
...
TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = ' יש לך ' .. black_money .. ' כסף שחור '})
	...
	if xPlayer.job.grade_name == 'boss' then
		...
		if society ~= nil then
			...
			money = 0
                ...
                --TriggerClientEvent('esx:showNotification', _source, 'You currently have ~g~$~g~' .. money .. ' ~s~in the society account~g~ ')
	        TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'יש לך ' .. money .. ' כסף במניות'})
